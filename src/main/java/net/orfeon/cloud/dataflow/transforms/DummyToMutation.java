...
public class DummyToMutation extends PTransform<PBegin, PCollection<Mutation>> {
    ...
    public class ReadSchemaDoFn extends DoFn<String, TableSchemas> {
    ...
    */
    ...
    public class AddSeqNumberDoFn extends DoFn<TableSchemas, KV<Long, TableSchemas>> {
    ...
    public class GroupByDummyGenerateDoFn extends DoFn<KV<Long, Iterable<TableSchemas>>, Mutation> {
    ...
    public interface DummyGenerator {
    ...
    public static class BytesDummyGenerator implements DummyGenerator {
        ...
        public Mutation.WriteBuilder putDummyValues(Mutation.WriteBuilder builder, long value) {
            List<ByteArray> randomValues = DummyGenerator.generateValues(this, value);
            return builder.set(this.fieldName).toBytesArray(randomValues);
        }

    }

    public static class IntDummyGenerator implements DummyGenerator {
    ...
    public static class FloatDummyGenerator implements DummyGenerator {
        ...
        public Mutation.WriteBuilder putDummyValues(Mutation.WriteBuilder builder, long value) {
            List<Double> randomValues = DummyGenerator.generateValues(this, value);
            return builder.set(this.fieldName).toFloat64Array(randomValues);
        }

    }

    public static class BoolDummyGenerator implements DummyGenerator {
    ...
    public static class DateDummyGenerator implements DummyGenerator {
        ...
        public DateDummyGenerator(String fieldName, List<String> range, Boolean isPrimary, Boolean isNullable, int randomRate) {
            ...
            LocalDateTime ldt2 = LocalDateTime.parse(endDateStr.length() == 10 ? endDateStr + "T00:00:00" : endDateStr);
        ...
        public Mutation.WriteBuilder putDummyValues(Mutation.WriteBuilder builder, long value) {
            List<Date> randomValues = DummyGenerator.generateValues(this, value);
            return builder.set(this.fieldName).toDateArray(randomValues);
        }

    }

    public static class TimestampDummyGenerator implements DummyGenerator {
        ...
        public Mutation.WriteBuilder putDummyValues(Mutation.WriteBuilder builder, long value) {
            List<Timestamp> randomValues = DummyGenerator.generateValues(this, value);
