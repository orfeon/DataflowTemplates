...
public class AvroViewer {
    ...
    public static List<GenericRecord> getGenericRecord(final File file) throws IOException {
    ...
    public static void printAvroBinary(final File file) throws IOException {
